...
namespace Thirdweb
{
	public class ThirdwebManager : MonoBehaviour
	{
		...
		public GameObject EmbeddedWalletPrefab => _embeddedWalletPrefab;

		public GameObject MetamaskPrefab => _metamaskPrefab;

		public GameObject WalletConnectPrefab => _walletConnectPrefab;

		public bool ShowDebugLogs => _showDebugLogs;

		public ThirdwebSDK SDK => _sdk;

		public IReadOnlyList<ChainData> SupportedChains => _supportedChains;

		public string ActiveChain => _activeChain;
		...
		private string _bundleIdOverride;
		...
		private void Awake()
		{
			...
			{
				Initialize(_activeChain, _defaultBundleIdOverride);
			}
		}
		...
		public void Initialize(string chainIdentifier, string overrideBundleId = null)
		{
			...
			foreach(ChainData chainData in _supportedChains)
			{
				...
				if(chainData.Identifier == _activeChain)
				{
			...
			if(!string.IsNullOrEmpty(_storageIpfsGatewayUrl))
			{
				...
				{
					ipfsGatewayUrl = _storageIpfsGatewayUrl
				};
			}
			...
			// Set up wallet data
			_thirdwebConfig = Resources.Load<ThirdwebConfig>("ThirdwebConfig");
		...
		public ChainData GetSupportedChainDataById(string identifier)
		{
			return _supportedChains.Find(x => x.Identifier == identifier);
		}

		public void SwitchActiveChain(string newChain)
		{
